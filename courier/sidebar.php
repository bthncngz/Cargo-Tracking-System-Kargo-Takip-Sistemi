  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
   	<a href="./" class="brand-link">
        ...
        <h3 class="text-center p-0 m-0"><b>ADA AV</b></h3>
        <?php else: ?>
        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Kurye Tarafından<br/>Alınan Kargolar","Toplanan Kargolar","Sevk Edilen Kargolar","Sevk Edilmekte Olan Kargolar","Hedefe Ulaşan<br/>Kargolar","Dağıtımdaki Kargolar","Teslim Edilmeye Hazır Kargolar","Gönderilen Kargolar","Teslim Alınan Kargolar","Başarısız<br/>Kargo İşlemleri");
