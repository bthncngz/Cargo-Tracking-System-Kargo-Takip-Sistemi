...
<?php if($_SESSION['login_type'] == 1): ?>
        <div class="row">
          ...
          <hr>
          <?php 
              $status_arr = array("Kargo,kurye tarafından alındı","Toplanan Kargolar","Şubeye Sevk Edildi","Şubeye Sevk Edilmekte","Hedefe Ulaşan Kargolar","Dağıtımda","Teslime Hazır Kargolar","Kargo Gönderildi","Kargo Alındı","Başarısız Kargo İşlemi");
