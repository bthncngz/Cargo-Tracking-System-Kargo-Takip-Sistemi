...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			...
			<?php 
			$status_arr = array("Kurye Tarafından Alındı","Kargo Toplandı","Sevk Edildi","Sevk Edilmekte","Hedefe Ulaşıldı","Dağıtımda","Kargo Alınmaya Hazır","Gönderildi","Teslim Alındı","Başarısız Kargo İşlemi"); ?>
				<label for="date_from" class="mx-1">Durum</label>
				...
				<label for="date_from" class="mx-1">Bu Tarihten</label>
                ...
                <label for="date_to" class="mx-1">Bu Tarihe</label>
                ...
                <button class="btn btn-sm btn-primary mx-1 bg-gradient-primary" type="button" id='view_report'>Raporu Görüntüle</button>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
        					<button type="button" class="btn btn-success float-right" style="display: none" id="print"><i class="fa fa-print"></i> Yazdır</button>
						</div>
					</div>	
...
<noscript>
	...
	<h3 class="text-center"><b>Rapor</b></h3>
</noscript>
<div class="details d-none">
		<p><b>Tarih Aralığı:</b> <span class="drange"></span></p>
		<p><b>Durum:</b> <span class="status-field">Hepsi</span></p>
	</div>
<script>
