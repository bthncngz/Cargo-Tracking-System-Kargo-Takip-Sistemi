	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_staff"><i class="fa fa-plus"></i> Yeni Personel Ekle</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	_conf("Silmek İstediğinize Emin Misiniz ?","delete_staff",[$(this).attr('data-id')])
	})
	})
	function delete_staff($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Veriler Kaydedildi",'success')
					setTimeout(function(){
						location.reload()
					},1500)
