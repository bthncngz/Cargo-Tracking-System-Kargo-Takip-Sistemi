...
<table width="100%">
	<tr>
		<td colspan="3">Takip Numarası : <b><?php echo $row['reference_number'] ?></b></td>
	</tr>
	<tr>
		<td width="33.33%">
			<p><b>Gönderen: <?php echo ucwords($row['sender_name']); ?></b></p>
		</td>
		<td width="33.33%">
			<p><b>Alıcı: <?php echo ucwords($row['recipient_name']); ?></b></p>
		</td>
		<td width="33.33%"></td>
	</tr>
</table>
