	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-sm-6 form-group ">
                <label for="" class="control-label">Şube</label>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-staff">Kaydet</button>
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./index.php?page=staff_list">İptal</a>
  		</div>
  	</div>
	</div>
</div>
<script>
	$('#manage-staff').submit(function(e){
		...
		$.ajax({
          ...
          $('#msg').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> Kullanıcı Zaten Mevcut</div>')
          end_load()
        }
			}
		})
