	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="control-label">İletişim</label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="checkbox" name="type" id="dtype" <?php echo isset($type) && $type == 1 ? 'checked' : '' ?> data-bootstrap-switch data-toggle="toggle" data-on="Gönderici" data-off="Alıcı" class="switch-toggle status_chk" data-size="xs" data-offstyle="info" data-width="5rem" value="1">
              <small>Gönderici = Alıcı Adrese Kargolar</small>
              <small>, Alıcı = En Yakın Şubeyi Seçer</small>
            </div>
          </div>
          <div class="col-md-6" id=""  <?php echo isset($type) && $type == 1 ? 'style="display: none"' : '' ?>>
            <?php if($_SESSION['login_branch_id'] <= 0): ?>
              <div class="form-group" id="fbi-field">
                <label for="" class="control-label">Gönderici Adres</label>
            ...
            <div class="form-group" id="tbi-field">
              <label for="" class="control-label">Alıcı Adres</label>
        ...
        <div class="row">
          <div class="col-md-12 d-flex justify-content-end">
            <button  class="btn btn-sm btn-primary bg-gradient-primary" type="button" id="new_parcel"><i class="fa fa-item"></i> Ürün Ekle</button>
          </div>
        </div>
              <?php endif; ?>
      </form>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-parcel">Kaydet</button>
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./index.php?page=parcel_list">İptal</a>
  		</div>
  	</div>
	</div>
</div>
